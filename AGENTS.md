...
For `/onboarding/setup` and `/profile`, also follow the **Profile builder & onboarding setup** section in `DESIGN.md` (autosave copy, dashed media empties, platform URL validation, status tags, no submit CTA, no preview rail).
