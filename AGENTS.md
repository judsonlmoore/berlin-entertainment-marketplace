...
For `/onboarding/setup` and `/profile`, also follow the **Profile builder & onboarding setup** section in `DESIGN.md` (autosave copy, dashed media empties, platform URL validation, Publish CTA on the display-name strip, no preview rail).
